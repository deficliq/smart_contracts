...
// const DeficliqTimelock = artifacts.require("../contracts/DeficliqTimelock.sol");
// const DeficliqToken = artifacts.require("../contracts/DeficliqToken.sol");
...
module.exports = (deployer, network, accounts) => {
  ...
  // deployer.deploy(DeficliqToken).then(() => {
  //   return deployer.deploy(DeficliqTimelock, DeficliqToken.address);
  // });
};